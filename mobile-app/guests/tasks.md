...
- **Exportação controlada para parceiros** — permitir partilhar apenas a contagem/restrições alimentares com um parceiro de catering via Chat, sem expor a lista completa de contactos (relevante para GDPR — os convidados não deram consentimento para os seus dados serem partilhados com terceiros).
