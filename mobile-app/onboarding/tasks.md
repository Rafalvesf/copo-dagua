...
|---|---|---|
| Implementar `create-partner-profile-draft` e `complete-*-onboarding` como Edge Functions | Alta | Bloqueia todo o módulo |
| Fila de curadoria em `admin-web/moderation/` para `partner_profile.status = pending_review` | Alta | Sem isto, parceiros ficam presos em `pending_review` indefinidamente |
...
- Onboarding progressivo real para Parceiros — publicar com perfil "básico" e completar portefólio depois.
