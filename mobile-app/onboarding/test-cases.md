...
- [ ] Um Parceiro consegue completar o onboarding e o `partner_profile` fica em `pending_review`.
...
- [ ] Parceiro não consegue avançar do passo de portefólio sem pelo menos 1 foto.
...
- `create-partner-profile-draft` cria registo em `draft` e não aparece em queries do Marketplace (filtro `status = active`)

## Testes E2E
- Onboarding completo de Noivo até ao Dashboard
- Onboarding completo de Parceiro até ao ecrã "em revisão"
- Fechar app a meio e retomar
- Convite a parceiro com email já usado por Parceiro
