...
- Convite ao parceiro enviado para email já registado como Fornecedor → falha com mensagem clara, não cria estado inconsistente de role.
- Fornecedor tenta avançar do passo de portefólio sem foto → bloqueado (único passo verdadeiramente obrigatório além de nome/categoria).
